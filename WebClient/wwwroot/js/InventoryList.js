(() => {
  ...
  function identityComparer(a4, b2) {
    return a4 === b2;
  }
  function structuralComparer(a4, b2) {
    return deepEqual(a4, b2);
  }
  function shallowComparer(a4, b2) {
    return deepEqual(a4, b2, 1);
  }
  function defaultComparer(a4, b2) {
    return Object.is(a4, b2);
  }
  var comparer = {
  ...
  function deepEqual(a4, b2, depth) {
    if (depth === void 0) {
      depth = -1;
    }
    return eq(a4, b2, depth);
  }
  function eq(a4, b2, depth, aStack, bStack) {
    if (a4 === b2)
    ...
    switch (className) {
      ...
      case "[object Number]":
        if (+a4 !== +a4)
          return +b2 !== +b2;
        return +a4 === 0 ? 1 / +a4 === 1 / b2 : +a4 === +b2;
      case "[object Date]":
      case "[object Boolean]":
        return +a4 === +b2;
      case "[object Symbol]":
        return typeof Symbol !== "undefined" && Symbol.valueOf.call(a4) === Symbol.valueOf.call(b2);
      case "[object Map]":
      case "[object Set]":
        if (depth >= 0) {
          depth++;
    ...
    if (!areArrays) {
      if (typeof a4 != "object" || typeof b2 != "object")
        return false;
      var aCtor = a4.constructor, bCtor = b2.constructor;
      if (aCtor !== bCtor && !(isFunction(aCtor) && aCtor instanceof aCtor && isFunction(bCtor) && bCtor instanceof bCtor) && "constructor" in a4 && "constructor" in b2) {
        return false;
      }
    }
    if (depth === 0) {
    ...
    if (areArrays) {
      ...
      if (length !== b2.length)
        return false;
      while (length--) {
        if (!eq(a4[length], b2[length], depth - 1, aStack, bStack))
          return false;
      }
    } else {
      var keys2 = Object.keys(a4);
      var key;
      length = keys2.length;
      ...
      while (length--) {
        key = keys2[length];
        if (!(hasProp(b2, key) && eq(a4[key], b2[key], depth - 1, aStack, bStack)))
          return false;
      }
    }
    aStack.pop();
  ...
  var a = class extends HTMLElement {
    ...
    addController(t4) {
      var i4, s5;
      ((i4 = this.\u03A0U) !== null && i4 !== void 0 ? i4 : this.\u03A0U = []).push(t4), this.renderRoot !== void 0 && this.isConnected && ((s5 = t4.hostConnected) === null || s5 === void 0 || s5.call(t4));
    }
    removeController(t4) {
      var i4;
    ...
    \u03A0j(t4, i4, s5 = l) {
      ...
      if (r4 !== void 0 && s5.reflect === true) {
        const n7 = ((h4 = (e5 = s5.converter) === null || e5 === void 0 ? void 0 : e5.toAttribute) !== null && h4 !== void 0 ? h4 : o2.toAttribute)(i4, s5.type);
    ...
    requestUpdate(t4, i4, s5) {
      let e5 = true;
      t4 !== void 0 && (((s5 = s5 || this.constructor.getPropertyOptions(t4)).hasChanged || n2)(this[t4], i4) ? (this.L.has(t4) || this.L.set(t4, i4), s5.reflect === true && this.\u03A0h !== t4 && (this.\u03A0k === void 0 && (this.\u03A0k = new Map()), this.\u03A0k.set(t4, s5))) : e5 = false), !this.isUpdatePending && e5 && (this.\u03A0g = this.\u03A0q());
    }
    async \u03A0q() {
  ...
  var a2 = (t4) => {
    var i4;
    return v(t4) || typeof ((i4 = t4) === null || i4 === void 0 ? void 0 : i4[Symbol.iterator]) == "function";
  };
  ...
  var b = (t4) => (i4, ...s5) => ({ _$litType$: t4, strings: i4, values: s5 });
  var T = b(1);
  var x = b(2);
  ...
  var V = (t4, i4, s5) => {
    ...
    if (n7 === void 0) {
      ...
      l4._$litPart$ = n7 = new C(i4.insertBefore(c(), t5), t5, void 0, s5);
    }
    return n7.I(t4), n7;
  };
  ...
  var M = (t4, i4) => {
    ...
    let o6, h4 = i4 === 2 ? "<svg>" : "", u3 = f;
    for (let i5 = 0; i5 < s5; i5++) {
      const s6 = t4[i5];
      let l4, c3, d2 = -1, v2 = 0;
      for (; v2 < s6.length && (u3.lastIndex = v2, c3 = u3.exec(s6), c3 !== null); )
        v2 = u3.lastIndex, u3 === f ? c3[1] === "!--" ? u3 = _14 : c3[1] !== void 0 ? u3 = m : c3[2] !== void 0 ? (y.test(c3[2]) && (o6 = RegExp("</" + c3[2], "g")), u3 = p) : c3[3] !== void 0 && (u3 = p) : u3 === p ? c3[0] === ">" ? (u3 = o6 != null ? o6 : f, d2 = -1) : c3[1] === void 0 ? d2 = -2 : (d2 = u3.lastIndex - c3[2].length, l4 = c3[1], u3 = c3[3] === void 0 ? p : c3[3] === '"' ? g : $) : u3 === g || u3 === $ ? u3 = p : u3 === _14 || u3 === m ? u3 = f : (u3 = p, o6 = void 0);
      const a4 = u3 === p && t4[i5 + 1].startsWith("/>") ? " " : "";
      h4 += u3 === f ? s6 + r3 : d2 >= 0 ? (e5.push(l4), s6.slice(0, d2) + "$lit$" + s6.slice(d2) + n3 + a4) : s6 + n3 + (d2 === -2 ? (e5.push(void 0), i5) : a4);
    }
    const c2 = h4 + (t4[s5] || "<?>") + (i4 === 2 ? "</svg>" : "");
  ...
  var N = class {
    constructor({ strings: t4, _$litType$: i4 }, s5) {
      ...
      this.parts = [];
      let l4 = 0, r4 = 0;
      const u3 = t4.length - 1, d2 = this.parts, [v2, a4] = M(t4, i4);
      ...
      for (; (e5 = E.nextNode()) !== null && d2.length < u3; ) {
        if (e5.nodeType === 1) {
            ...
            for (const i5 of e5.getAttributeNames())
              if (i5.endsWith("$lit$") || i5.startsWith(n3)) {
                ...
                if (t5.push(i5), s6 !== void 0) {
                  const t6 = e5.getAttribute(s6.toLowerCase() + "$lit$").split(n3), i6 = /([.?@])?(.*)/.exec(s6);
                  d2.push({ type: 1, index: l4, name: i6[2], strings: t6, ctor: i6[1] === "." ? I : i6[1] === "?" ? L : i6[1] === "@" ? R : H });
                } else
          ...
          if (y.test(e5.tagName)) {
            const t5 = e5.textContent.split(n3), i5 = t5.length - 1;
            if (i5 > 0) {
  ...
  function S2(t4, i4, s5 = t4, e5) {
    var o6, l4, n7, h4;
    if (i4 === w)
      return i4;
    let r4 = e5 !== void 0 ? (o6 = s5.\u03A3i) === null || o6 === void 0 ? void 0 : o6[e5] : s5.\u03A3o;
    const u3 = d(i4) ? void 0 : i4._$litDirective$;
    return (r4 == null ? void 0 : r4.constructor) !== u3 && ((l4 = r4 == null ? void 0 : r4.O) === null || l4 === void 0 || l4.call(r4, false), u3 === void 0 ? r4 = void 0 : (r4 = new u3(t4), r4.T(t4, s5, e5)), e5 !== void 0 ? ((n7 = (h4 = s5).\u03A3i) !== null && n7 !== void 0 ? n7 : h4.\u03A3i = [])[e5] = r4 : s5.\u03A3o = r4), r4 !== void 0 && (i4 = S2(t4, r4.S(t4, i4.values), r4, e5)), i4;
  }
  var k = class {
    constructor(t4, i4) {
    ...
    u(t4) {
      var i4;
      const { el: { content: s5 }, parts: e5 } = this.D, o6 = ((i4 = t4 == null ? void 0 : t4.creationScope) !== null && i4 !== void 0 ? i4 : u2).importNode(s5, true);
      E.currentNode = o6;
      let l4 = E.nextNode(), n7 = 0, h4 = 0, r4 = e5[0];
      for (; r4 !== void 0; ) {
        if (n7 === r4.index) {
          let i5;
          r4.type === 2 ? i5 = new C(l4, l4.nextSibling, this, t4) : r4.type === 1 ? i5 = new r4.ctor(l4, r4.name, r4.strings, this, t4) : r4.type === 6 && (i5 = new z(l4, this, t4)), this.l.push(i5), r4 = e5[++h4];
        }
  ...
  var C = class {
    ...
    I(t4, i4 = this) {
      t4 = S2(this, t4, i4), d(t4) ? t4 === A || t4 == null || t4 === "" ? (this.H !== A && this.R(), this.H = A) : t4 !== this.H && t4 !== w && this.m(t4) : t4._$litType$ !== void 0 ? this._(t4) : t4.nodeType !== void 0 ? this.$(t4) : a2(t4) ? this.g(t4) : this.m(t4);
    }
    k(t4, i4 = this.B) {
    ...
    m(t4) {
      ...
      i4 !== null && i4.nodeType === 3 && (this.B === null ? i4.nextSibling === null : i4 === this.B.previousSibling) ? i4.data = t4 : this.$(u2.createTextNode(t4)), this.H = t4;
    }
    _(t4) {
      var i4;
      ...
      if (((i4 = this.H) === null || i4 === void 0 ? void 0 : i4.D) === o6)
        ...
        const t5 = new k(o6, this), i5 = t5.u(this.options);
        t5.v(s5), this.$(i5), this.H = t5;
      }
    }
    C(t4) {
      let i4 = P.get(t4.strings);
      return i4 === void 0 && P.set(t4.strings, i4 = new N(t4)), i4;
    }
    g(t4) {
      ...
      let s5, e5 = 0;
      for (const o6 of t4)
        e5 === i4.length ? i4.push(s5 = new C(this.k(c()), this.k(c()), this, this.options)) : s5 = i4[e5], s5.I(o6), e5++;
  ...
  var H = class {
    constructor(t4, i4, s5, e5, o6) {
      this.type = 1, this.H = A, this.N = void 0, this.V = void 0, this.element = t4, this.name = i4, this.M = e5, this.options = o6, s5.length > 2 || s5[0] !== "" || s5[1] !== "" ? (this.H = Array(s5.length - 1).fill(A), this.strings = s5) : this.H = A;
    }
    get tagName() {
    ...
    I(t4, i4 = this, s5, e5) {
      ...
      let l4 = false;
      if (o6 === void 0)
        t4 = S2(this, t4, i4, 0), l4 = !d(t4) || t4 !== this.H && t4 !== w, l4 && (this.H = t4);
      else {
        const e6 = t4;
        let n7, h4;
        for (t4 = o6[0], n7 = 0; n7 < o6.length - 1; n7++)
          h4 = S2(this, e6[s5 + n7], i4, n7), h4 === w && (h4 = this.H[n7]), l4 || (l4 = !d(h4) || h4 !== this.H[n7]), h4 === A ? t4 = A : t4 !== A && (t4 += (h4 != null ? h4 : "") + o6[n7 + 1]), this.H[n7] = h4;
      }
      l4 && !e5 && this.W(t4);
    }
    W(t4) {
  ...
  var R = class extends H {
    ...
    I(t4, i4 = this) {
      var s5;
      if ((t4 = (s5 = S2(this, t4, i4, 0)) !== null && s5 !== void 0 ? s5 : A) === w)
        return;
  ...
  var MobxLitElement = class extends MobxReactionUpdate(h3) {
  };
  ...
  var __assign = function() {
    __assign = Object.assign || function __assign2(t4) {
      for (var s5, i4 = 1, n7 = arguments.length; i4 < n7; i4++) {
        s5 = arguments[i4];
        for (var p2 in s5)
  ...
  var CollectedMiddlewares = function() {
    function CollectedMiddlewares2(node, fn) {
      ...
      while (n7) {
        if (n7.middlewares)
          this.middlewares.push(n7.middlewares);
        n7 = n7.parent;
      }
    }
  ...
  function flattenTypeErrors(errors2) {
    return errors2.reduce(function(a4, i4) {
      return a4.concat(i4);
    }, []);
  }
      ...
      value: function(node) {
        ...
        entries(this.cache).forEach(function(_a2) {
          ...
          for (var i4 = nodes.length - 1; i4 >= 0; i4--) {
            if (nodes[i4].path.indexOf(basePath) === 0) {
              res.addNodeToCache(nodes[i4], false);
              nodes.splice(i4, 1);
              modified = true;
            }
          }
      ...
      value: function(type, identifier2) {
        ...
        switch (matches.length) {
          ...
          case 1:
            return matches[0];
          default:
            throw fail$1("Cannot resolve a reference to type '" + type.name + "' with id: '" + identifier2 + "' unambigously, there are multiple candidates: " + matches.map(function(n7) {
              return n7.path;
            }).join(", "));
        }
      }
  ...
  function resolveNodeByPathParts(base, pathParts, failIfResolveFails) {
    ...
    for (var i4 = 0; i4 < pathParts.length; i4++) {
      ...
      if (failIfResolveFails)
        throw fail$1("Could not resolve '" + part + "' in path '" + (joinJsonPath(pathParts.slice(0, i4)) || "/") + "' while resolving '" + joinJsonPath(pathParts) + "'");
      else
        return void 0;
    }
    return current;
          ...
          case "splice":
            {
              ...
              var addedNodes = reconcileArrayChildren(node, subType, childNodes.slice(index_1, index_1 + removedCount), added, added.map(function(_15, i5) {
                return index_1 + i5;
              }));
              if (!addedNodes) {
                return null;
          ...
          case "splice":
            ...
            for (var i4 = 0; i4 < change.addedCount; i4++)
              node.emitPatch({
                op: "add",
                path: "" + (change.index + i4),
                value: node.getChildNode("" + (change.index + i4)).snapshot,
                oldValue: void 0
              }, node);
            return;
        }
    ...
    Object.defineProperty(Union2.prototype, "determineType", {
      ...
      value: function(value, reconcileCurrentType) {
        ...
        if (reconcileCurrentType) {
          ...
          return this._types.filter(function(t4) {
            return t4 !== reconcileCurrentType;
          }).find(function(type) {
  ...
  var Late = function(_super) {
    ...
    Object.defineProperty(Late2.prototype, "describe", {
      ...
      writable: true,
      value: function() {
        var t4 = this.getSubType(false);
        return t4 ? t4.name : "<uknown late type>";
      }
    });
    Object.defineProperty(Late2.prototype, "isValidSnapshot", {
      ...
      value: function(value, context) {
        ...
        return t4.validate(value, context);
      }
    });
    Object.defineProperty(Late2.prototype, "isAssignableFrom", {
      ...
      value: function(type) {
        var t4 = this.getSubType(false);
        return t4 ? t4.isAssignableFrom(type) : false;
      }
    });
  ...
  var inventoryRow = ({ id, name, price }) => T`
    <tr>
        <td>${name}</td>
        <td>${price}</td>
        <td>
