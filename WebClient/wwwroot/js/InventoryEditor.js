(() => {
  ...
  function runReactionsHelper() {
    ...
    while (allReactions.length > 0) {
      ...
      for (var i5 = 0, l4 = remainingReactions.length; i5 < l4; i5++) {
  ...
  function spyReport(event) {
    ...
    for (var i5 = 0, l4 = listeners.length; i5 < l4; i5++) {
      listeners[i5](event);
    }
  }
  ...
  function interceptChange(interceptable, change) {
    ...
    try {
      ...
      for (var i5 = 0, l4 = interceptors.length; i5 < l4; i5++) {
  ...
  var __assign = function() {
    __assign = Object.assign || function __assign2(t4) {
      for (var s5, i5 = 1, n7 = arguments.length; i5 < n7; i5++) {
        s5 = arguments[i5];
        for (var p2 in s5)
  ...
  function __read(o6, n7) {
    ...
    try {
      while ((n7 === void 0 || n7-- > 0) && !(r4 = i5.next()).done)
        ar.push(r4.value);
    } catch (error) {
      e5 = { error };
    } finally {
  ...
  function flattenTypeErrors(errors2) {
    return errors2.reduce(function(a4, i5) {
      return a4.concat(i5);
    }, []);
  }
    ...
    Object.defineProperty(IdentifierCache2.prototype, "splitCache", {
      ...
      value: function(node) {
        ...
        entries(this.cache).forEach(function(_a2) {
          ...
          var modified = false;
          for (var i5 = nodes.length - 1; i5 >= 0; i5--) {
            if (nodes[i5].path.indexOf(basePath) === 0) {
              res.addNodeToCache(nodes[i5], false);
              nodes.splice(i5, 1);
              modified = true;
            }
          }
  ...
  function resolveNodeByPathParts(base, pathParts, failIfResolveFails) {
    ...
    var current = base;
    for (var i5 = 0; i5 < pathParts.length; i5++) {
      var part = pathParts[i5];
      if (part === "..") {
      ...
      if (failIfResolveFails)
        throw fail$1("Could not resolve '" + part + "' in path '" + (joinJsonPath(pathParts.slice(0, i5)) || "/") + "' while resolving '" + joinJsonPath(pathParts) + "'");
      else
        return void 0;
    }
    return current;
          ...
          case "splice":
            {
              ...
              var addedNodes = reconcileArrayChildren(node, subType, childNodes.slice(index_1, index_1 + removedCount), added, added.map(function(_15, i6) {
                return index_1 + i6;
              }));
              if (!addedNodes) {
                return null;
              ...
              for (var i5 = index_1 + removedCount; i5 < childNodes.length; i5++) {
                childNodes[i5].setParent(node, "" + (i5 + added.length - removedCount));
              }
            }
            break;
        }
    ...
    Object.defineProperty(ArrayType2.prototype, "didChange", {
      ...
      value: function(change) {
        ...
        switch (change.type) {
          ...
          case "splice":
            for (var i5 = change.removedCount - 1; i5 >= 0; i5--)
              node.emitPatch({
                op: "remove",
                path: "" + (change.index + i5),
                oldValue: change.removed[i5].snapshot
              }, node);
            for (var i5 = 0; i5 < change.addedCount; i5++)
              node.emitPatch({
                op: "add",
                path: "" + (change.index + i5),
                value: node.getChildNode("" + (change.index + i5)).snapshot,
                oldValue: void 0
              }, node);
            return;
        }
  ...
  function reconcileArrayChildren(parent, childType, oldNodes, newValues, newPaths) {
    ...
    for (var i5 = 0; ; i5++) {
      var hasNewNode = i5 <= newValues.length - 1;
      var oldNode = oldNodes[i5];
      var newValue = hasNewNode ? newValues[i5] : void 0;
      var newPath = "" + newPaths[i5];
      if (isNode(newValue))
      ...
      if (!oldNode && !hasNewNode) {
        ...
        oldNodes.splice(i5, 0, newNode);
      } else if (areSame(oldNode, newValue)) {
        oldNodes[i5] = valueAsNode(childType, parent, newPath, newValue, oldNode);
      } else {
        var oldMatch = void 0;
        for (var j = i5; j < oldNodes.length; j++) {
  ...
  function compose() {
    ...
    if (devMode()) {
      args.forEach(function(type, i5) {
        assertArg(type, isModelType, "mobx-state-tree model type", hasTypename ? i5 + 2 : i5 + 1);
      });
    }
  ...
  function enumeration(name, options) {
    ...
    if (devMode()) {
      realOptions.forEach(function(option, i5) {
        assertIsString(option, i5 + 1);
      });
    }
  ...
  var Union = function(_super) {
    ...
    Object.defineProperty(Union2.prototype, "isValidSnapshot", {
      ...
      value: function(value, context) {
        ...
        for (var i5 = 0; i5 < this._types.length; i5++) {
          var type = this._types[i5];
  ...
  function union(optionsOrType) {
    ...
    if (devMode()) {
      ...
      types2.forEach(function(type, i5) {
        assertIsType(type, options ? i5 + 2 : i5 + 1);
      });
    }
  ...
  var itemEditor = (item, onSave) => T`
    <form @submit=${handleSubmit(() => onSave())}>
        ...
        <label>
            <p>Price</p>
            <input type="number" step="0.01" min="0.01" .value=${item.price} @change=${handlePropChange(item, (item2, val) => item2.setPrice(Number(val) ?? 0.01))}
            required />
        </label>
  ...
  InventoryEditor = __decorateClass([
    n5("inventory-editor")
  ], InventoryEditor);
})();
/*! *****************************************************************************
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
//# sourceMappingURL=InventoryEditor.js.map
